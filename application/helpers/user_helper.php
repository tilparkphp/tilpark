...
{
	if($role == 5){ $user['role_name'] = get_lang('Staff'); }
	else if($role == 4){ $user['role_name'] = get_lang('Authorized Personnel'); }
	else if($role == 3){ $user['role_name'] = get_lang('Chief'); }
	else if($role == 2){ $user['role_name'] = get_lang('Admin'); }
	else if($role == 1){ $user['role_name'] = get_lang('Super Admin'); }
